...
public class Simulator {
	...
	private static void startPhase(ActionSerialized[] tempPhase, CountDownLatch latchy){
		for (int i = 0; i < tempPhase.length; i++) {
			...
			//System.out.println("tempPhase[i].getDesignatedActor()" + tempPhase[i].getDesignatedActor());
	...
	public static void main(String [] args){
		...
		try {
			...
			//JsonReader jsonReader = new JsonReader(new FileReader("C:/USERS/NIlyasov/Desktop/phaseone.json"));
			...
			ActorThreadPool tempActorThreadPool = new ActorThreadPool(json.getThreads()-6);
