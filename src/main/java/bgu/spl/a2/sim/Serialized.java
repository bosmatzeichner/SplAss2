...
import bgu.spl.a2.sim.actions.CheckAdministrativeObligationsAction;
import bgu.spl.a2.sim.actions.CloseACourseAction;
import bgu.spl.a2.sim.actions.OpenANewCourseAction;
import bgu.spl.a2.sim.actions.OpeningNewPlacesInCourseAction;
import bgu.spl.a2.sim.actions.ParticipatingInCourseAction;
import bgu.spl.a2.sim.actions.RegisterWithPreferencesAction;
import bgu.spl.a2.sim.actions.UnregisterAction;
	...
	public class ActionSerialized{
		...
		public Action<?> getActualAction() {
			...
			case "Administrative Check":{
				this.designatedActor = departmentName;
				this.designatedActorPrivateState = new DepartmentPrivateState();
				actualAction = new CheckAdministrativeObligationsAction(computerType, prerequisites, students);
				break;
			}
			default:
				break;
